...
Если ваша среда не позволяет добавлять дополнительные зависимости, то вы можете создать свою собственную фабрику следуя [этим указаниями](/ru/explanation/sids/#custom-factories).
